...
void setup() {
  ...
  */
  ...
  Serial.print("Calibrating please wait."); //신선한 공기의 값을 계산
  float calcR0 = 0;
  for(int i = 1; i<=10; i ++)
  {
...
void loop() {
  ...
  //센서값 측정하고 request 전송하기
   MQ6.update(); // 1회 호출
  float data1 = MQ6.readSensor(); //가스농도값
  int data2 = analogRead(39); //조도센서값

  //bssm2_3/gas.php?gas=12.34&cds=1234
